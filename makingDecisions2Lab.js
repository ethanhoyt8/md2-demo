...
////////// PROBLEM 1 //////////
/*
  Create a variable named 'firstItem' and set it equal to the first value of 
  the 'arr' array.
*/
...
// What happens if you 
// subscript to 
// the 7th element, but there are not 7 elements in the array? 
// Let's write some code to check for that. 
// // Use an if statement to check the length of the 'myFavoriteNumbers' array. 
// If it's less than 7, log 'There are not enough elements in this array' 
// to the console. 
...
// Use a for-loop to iterate through 'listOfNumbers', checking to see 
// if each number is divisible by 3. If it is, console.log '{number} is divisible by 3.'
...
/* The famous FizzBuzz, Devmountain style!
  ...
  using some conditional logic, if the number your for loop is currently on 
